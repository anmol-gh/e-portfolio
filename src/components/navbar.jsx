import anmol from "./static/anmol 1.png";
const Navbar = () => {
  return (
    <header className="w-full text-gray-600 body-font">
      <div className="bg-purple-50 flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a
        ...
        >
          ...
          <img src={anmol} className="h-8"></img>
        ...
        {/* <a
          className="inline-flex items-center bg-gray-300 border-0 py-1 px-3 focus:outline-none hover:bg-red-100 hover:text-indigo-600 rounded text-base mt-4 md:mt-0"
          href="/project"
        >
          Team Project
          <svg
